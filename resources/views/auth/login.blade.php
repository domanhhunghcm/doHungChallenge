                    ...
                    <div class="login-form">
                        <form action="{{ route('login') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                align-items: center;
                                justify-content: center;"><a href="#" style="width:58%;background-color: #36a420;border-color: #36a420;" class="set-border btn btn-primary btn-block">Create an Account</a></p>
                            </div>
                            <div class="clearfix">
